...
using EMRSystem.Models.TokenAuth;
...
public abstract class EMRSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static EMRSystemWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(EMRSystemWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<EMRSystemDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<EMRSystemDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<EMRSystemDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<EMRSystemDbContext, Task<T>> func)
    {
        T result;
