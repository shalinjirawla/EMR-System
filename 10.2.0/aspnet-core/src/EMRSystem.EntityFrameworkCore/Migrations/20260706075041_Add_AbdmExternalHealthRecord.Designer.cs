...
namespace EMRSystem.Migrations
{
    ...
    [Migration("20260706075041_Add_AbdmExternalHealthRecord")]
    partial class Add_AbdmExternalHealthRecord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EMRSystem.Abdm.Abha.PatientAbhaDetails", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("EnrolmentReferenceId")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("PatientAbhaDetails");
                });

            modelBuilder.Entity("EMRSystem.Abdm.Consent.AbdmConsentRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AbdmConsentRequests");
                });

            modelBuilder.Entity("EMRSystem.Abdm.HealthInformation.AbdmExternalHealthRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AbdmExternalHealthRecords");
                });

            modelBuilder.Entity("EMRSystem.Abdm.HealthInformation.AbdmHealthInformationTask", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("EncryptedDataUrl")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("AbdmHealthInformationTasks");
                });
            ...
            modelBuilder.Entity("EMRSystem.BirthRecord.BirthRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EMRSystem.Deposit.DepositTransaction", b =>
                {
                    ...
                    b.Property<string>("RefundReceiptNo")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EMRSystem.BirthRecord.BirthRecord", b =>
                {
                    ...
                    b.HasOne("EMRSystem.Patients.Patient", "Mother")
                        .WithMany()
