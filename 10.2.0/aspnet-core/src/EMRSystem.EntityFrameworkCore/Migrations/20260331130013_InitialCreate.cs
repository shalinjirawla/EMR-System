        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultCharge = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmergencyProcedures", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsEmergencyCharge = table.Column<bool>(type: "bit", nullable: false),
                    FullName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Gender = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isEmergencyDoctor = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Strength = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    StrengthUnitId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsClaimGenerated = table.Column<bool>(type: "bit", nullable: false),
                    InsuranceClaimId = table.Column<long>(type: "bigint", nullable: true),
                    ...
                    IsConvertedToFinalInvoice = table.Column<bool>(type: "bit", nullable: false),
                    FinalInvoiceId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovedAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    NotApprovedAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReasonForAdmit = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillingMode = table.Column<int>(type: "int", nullable: false),
                    PatientInsuranceId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "int", nullable: false),
                    PatientId = table.Column<long>(type: "bigint", nullable: true),
                    EmergencyNumber = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ...
                    DoctorId = table.Column<long>(type: "bigint", nullable: true),
                    NurseId = table.Column<long>(type: "bigint", nullable: true),
                    AdmissionsId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvestigationSummary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConditionAtDischarge = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DietAdvice = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Activity = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FollowUpDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    FollowUpDoctorId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientDischarges", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsEmergencyPrescription = table.Column<bool>(type: "bit", nullable: false),
                    EmergencyCaseId = table.Column<long>(type: "bigint", nullable: true),
                    DoctorId = table.Column<long>(type: "bigint", nullable: true),
                    SpecialistDoctorId = table.Column<long>(type: "bigint", nullable: true),
                    IsSpecialAdviceRequired = table.Column<bool>(type: "bit", nullable: false),
                    DepartmentId = table.Column<long>(type: "bigint", nullable: true),
                    PatientId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefundReceiptNo = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickedUpByNurse = table.Column<long>(type: "bigint", nullable: true),
                    PickedUpByPatient = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPaid = table.Column<bool>(type: "bit", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ProcedureReceiptId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MedicineName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NumberOfMedicine = table.Column<int>(type: "int", nullable: false),
                    Frequency = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PrescriptionId = table.Column<long>(type: "bigint", nullable: true),
                    MedicineId = table.Column<int>(type: "int", nullable: false),
                    Qty = table.Column<int>(type: "int", nullable: false),
                    UnitPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsPrescribe = table.Column<bool>(type: "bit", nullable: false),
                    PharmacistPrescriptionId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
