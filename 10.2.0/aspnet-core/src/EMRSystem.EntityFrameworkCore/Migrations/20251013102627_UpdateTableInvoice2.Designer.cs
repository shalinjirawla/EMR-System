...
namespace EMRSystem.Migrations
{
    ...
    [Migration("20251013102627_UpdateTableInvoice2")]
    partial class UpdateTableInvoice2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EMRSystem.Insurances.InsuranceClaim", b =>
                {
                    ...
                    b.Property<long?>("PatientInsuranceId1")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PatientInsuranceId1");
            ...
            modelBuilder.Entity("EMRSystem.Insurances.InsuranceClaim", b =>
                {
                    ...
                    b.HasOne("EMRSystem.Invoices.Invoice", null)
                    ...
                    b.HasOne("EMRSystem.Insurances.PatientInsurance", null)
                        .WithMany("InsuranceClaims")
                        .HasForeignKey("PatientInsuranceId1");
