...
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
    ...
    getMenuItems(): MenuItem[] {
        return [
           ...
           new MenuItem('Doctor', '', 'fa fa-user-md', '', [
    new MenuItem('Appointments', '/app/doctors/appointments', 'fa fa-calendar'),
    new MenuItem('Patients', '/app/doctors/patients', 'fa fa-user-circle'),
    new MenuItem('Prescriptions', '/app/doctors/prescriptions', 'fa-solid fa-prescription'),
    new MenuItem('Visits', '/app/doctors/visits', 'fa fa-bed'),
    new MenuItem('Lab Orders', '/app/doctors/lab-order', 'fa fa-flask'),
