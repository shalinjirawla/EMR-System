...
@Component({
  ...
  imports: [LocalizePipe, InputTextModule, BreadcrumbModule, CardModule, TooltipModule, TableModule, TagModule, PaginatorModule, FormsModule, NgIf, PrimeTemplate, ChipModule,
    OverlayPanelModule, MenuModule, ButtonModule],
...
export class DepositComponent extends PagedListingComponentBase<PatientDepositDto> implements OnInit {
  ...
  selectedRecord: PatientDepositDto;
    ...
    this.editDeleteMenus = [
      {
        ...
        command: () => this.collectDeposit(this.selectedRecord)  // call edit
      },
      {
        label: 'View Deposit Receipts',
        icon: 'pi pi-file',
        command: () => this.viewReceipts(this.selectedRecord)  // call edit
      },
      {
        label: 'View Transactions',
        icon: 'pi pi-list',
        command: () => this.viewTransactions(this.selectedRecord)  // call edit
      }
